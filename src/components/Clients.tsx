    ...
    <section className="py-24 px-6 bg-white">
      <div className="max-w-7xl mx-auto text-center mb-20">
        <motion.h2 
          ...
          viewport={{ once: true }}
          className="text-4xl md:text-5xl font-black text-[#0f172a] mb-6 font-display tracking-tight"
        >
          Trusted by Global <span className="text-secondary">Innovation Leaders</span>
        </motion.h2>
        <motion.p 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          ...
          className="text-[#64748b] text-lg max-w-3xl mx-auto leading-relaxed font-medium"
        >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {clients.map((client, i) => (
            <motion.div
              ...
              className="group bg-white p-8 rounded-[2rem] shadow-xl shadow-black/5 flex items-center justify-center min-h-[140px] hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 border border-slate-50"
            >
              ...
              <div className="relative w-full h-full flex items-center justify-center">
                ...
                />
                <span className={`hidden text-2xl font-black tracking-tighter text-center transition-all duration-300 ${client.color}`}>
                  {client.name}
                </span>
              </div>
            </motion.div>
